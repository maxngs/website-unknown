...
const HeroBackground = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Floating particles */}
      {particles.map((p) => (
        <div key={p.id} className="particle absolute rounded-full bg-emerald-400" style={{
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[800px] h-[400px] opacity-[0.05]" style={{
        background: "conic-gradient(from 0deg, transparent 0deg, rgba(16,185,129,0.3) 30deg, transparent 60deg, transparent 120deg, rgba(20,184,166,0.2) 150deg, transparent 180deg, transparent 240deg, rgba(5,150,105,0.2) 270deg, transparent 300deg)",
        filter: "blur(40px)",
