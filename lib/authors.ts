...
export const AUTHORS: Record<AuthorSlug, Author> = {
  "maxime-nogues": {
    ...
    name: "Maxime Noguès",
    role: "Fondateur & CTO",
    bio: "Suite à une frustration personnelle, Maxime a fondé Hiry dans le but de transformer totalement l'expérience du recrutement. Son constat : malgré la multiplication des solutions, trouver un job — comme recruter la bonne personne — reste un parcours cassé, frustrant, chronophage et démotivant. Sa mission : faire de ce moment anxiogène une expérience fluide, intuitive, fun et ultra simple. Aujourd'hui CTO, il code la plateforme et porte la vision produit aux côtés de sa mère Stéphanie.",
  ...
  "stephanie-nogues": {
    ...
    bio: "Stéphanie Noguès apporte 25 ans d'expérience dont 17 d'expertise B2B et institutionnelle dans les grands groupes tech. Diplômée de l'ESCP, elle a piloté et mis en place des partenariats stratégiques avec les géants de la Tech. Elle structure l'opérationnel et les relations partenaires de Hiry.",
    ...
    worksHistory: ["Partenariats stratégiques avec les géants de la Tech"],
  },
};
